...
ctld.minimumDeployDistance = 5 -- minimum distance from a friendly pickup zone where you can deploy a crate
...
ctld.pickupZones = {
    { "Megiddo", "none", -1, "yes", 2 },
    { "zone1pickup", "none", 10, "yes", 2, 11 },
    { "zone2pickup", "none", 10, "yes", 2, 12 },
    { "zone3pickup", "none", 10, "yes", 2, 13 },
}
...
ctld.transportPilotNames = {
    ...
    "Hokum #003",       -- Ka-50
    "Hokum #004",       -- Ka-50
    "GazelleCAS #001",  -- SA342L
    "GazelleCAS #002",  -- SA342L
    "GazelleAT #001",   -- SA342M
    "GazelleAT #002",   -- SA342M
    "GazelleAA #001",   -- SA342Mistral
    "GazelleAA #002",   -- SA342Mistral
}
...
ctld.unitActions = {
    ...
    ["OH-58D"] = {crates=false, troops=true},
    ["AH-64D"] = {crates=true, troops=false},
...
ctld.loadableGroups = {
    {name = "Rifle Squad", inf = 8, mg = 2, at = 2 },
    {name = "Large Rifle Squad", inf = 12, mg = 4, at = 4 }, -- will make a loadable group with 5 infantry, 2 MGs and 2 anti-tank for both coalitions
    {name = "Anti Air Team", aa = 3  },
    {name = "Anti Tank Team", at = 3  },
    {name = "Anti Tank Squad", inf = 2, at = 6  },
    {name = "Mortar Team", mortar = 3 },
}
...
ctld.spawnableCrates = {
    ...
    ["Ground Forces"] = {
        ...
        { weight = 600, desc = "M1A2 Abrams", unit = "M-1 Abrams", side = 2 },
        { weight = 505, desc = "M2A3 Bradley", unit = "M-2 Bradley", side = 2 },
        { weight = 610, desc = "M109 Paladin", unit = "M-109", side = 2 },
        { weight = 350, desc = "M818 Ammo Truck", unit = "M 818", side = 2 },
        { weight = 800, desc = "FOB Crate", unit = "FOB-SMALL" }, -- Builds a FOB! - requires 3 * ctld.cratesRequiredForFOB
    },
    ["AA Crates"] = {
         -- HAWK System
        ...
        -- End of HAWK
        { weight = 405, desc = "M6 Linebacker", unit = "M6 Linebacker", side = 2 },
        { weight = 410, desc = "Flakpanzer Gepard", unit = "Gepard", side = 2 },
        { weight = 450, desc = "Roland ADS", unit = "Roland ADS", side = 2 },
    ...
    for _, _nearbyCrate in pairs(_crates) do
        ...
        if _nearbyCrate.dist < 750  then
            ...
            if _smallFobCrates > 0 then
                _totalCrates = _bigFobCrates + (_smallFobCrates/1.0)
            else
